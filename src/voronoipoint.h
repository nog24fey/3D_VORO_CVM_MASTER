...
public:
   ...
   double tpox_,tpoy_,tpoz_;
   double tpnx_,tpny_,tpnz_;//tempral storage variables for stochastic Runge-Kutta
};
...
VoronoiPoint::VoronoiPoint(const VoronoiPoint &v) {
   ...
   tpox_ = v.tpox_; tpoy_ = v.tpoy_; tpoz_ = v.tpoz_;
   tpnx_ = v.tpnx_; tpny_ = v.tpny_; tpnz_ = v.tpnz_;
}
